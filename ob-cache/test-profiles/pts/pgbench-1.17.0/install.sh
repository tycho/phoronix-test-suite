...
patch -p0 <<'EOF'
diff -Naur postgresql-18.1.orig/src/backend/main/main.c postgresql-18.1/src/backend/main/main.c
--- postgresql-18.1.orig/src/backend/main/main.c	2025-09-22 15:11:33.000000000 -0500
+++ postgresql-18.1/src/backend/main/main.c	2025-10-02 15:22:21.487434732 -0500
@@ -70,7 +70,7 @@
 int
...
+	bool		do_check_root = false;
 	...
 	reached_main = true;
diff -Naur postgresql-18.1.orig/src/bin/initdb/initdb.c postgresql-18.1/src/bin/initdb/initdb.c
--- postgresql-18.1.orig/src/bin/initdb/initdb.c	2025-09-22 15:11:33.000000000 -0500
+++ postgresql-18.1/src/bin/initdb/initdb.c	2025-10-02 15:22:52.034821709 -0500
@@ -816,7 +816,7 @@
 {
 	const char *username;
...
diff -Naur postgresql-18.1.orig/src/bin/pg_ctl/pg_ctl.c postgresql-18.1/src/bin/pg_ctl/pg_ctl.c
--- postgresql-18.1.orig/src/bin/pg_ctl/pg_ctl.c	2025-09-22 15:11:33.000000000 -0500
+++ postgresql-18.1/src/bin/pg_ctl/pg_ctl.c	2025-10-02 15:23:46.144033746 -0500
@@ -2253,7 +2253,7 @@
 	/*
...
diff -Naur postgresql-18.1.orig/src/bin/pg_upgrade/option.c postgresql-18.1/src/bin/pg_upgrade/option.c
--- postgresql-18.1.orig/src/bin/pg_upgrade/option.c	2025-09-22 15:11:33.000000000 -0500
+++ postgresql-18.1/src/bin/pg_upgrade/option.c	2025-10-02 15:24:18.379686139 -0500
@@ -105,10 +105,6 @@
 		}
 	}
