...
./build.sh --config Release --build_shared_lib --compile_no_warning_as_error --parallel --skip_tests --enable_lto --cmake_extra_defines onnxruntime_BUILD_FOR_NATIVE_MACHINE=ON
