                ...
                <key name="Three Kingdoms">
                    <key name="Setup">
                        ...
                        <key name="SpecificationAlerts">
                            <value name="LnxCPUGovernorSubOptimal" type="integer">0</value>
                            <value name="ModsHaveBeenDisabled" type="integer">0</value>
                            <value name="ModsHaveBeenDisabled_1_0_4" type="integer">0</value>
                        </key>
                    </key>
                </key>
            </key>
